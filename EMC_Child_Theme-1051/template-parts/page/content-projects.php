...
<div class="w3-cell-row abc">
  <div class="w3-container w3-cell w3-cell-top w3-mobile col">
    <img class="three_projects_img" src="<?php echo the_sub_field('three_project_layout_images_one') ?>">
  ...
  <img class="three_projects_img" src="<?php echo the_sub_field('three_project_layout_images_two') ?>">
  ...
  <div class="w3-container w3-mobile w3-cell col">
  <img class="three_projects_img" src="<?php echo the_sub_field('three_project_layout_images_three') ?>">
